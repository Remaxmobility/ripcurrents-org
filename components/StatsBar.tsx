...
const STATS = [
  { end: 71,      suffix: '',   label: 'avg. U.S. deaths annually',      prefix: '' },
  { end: 80,      suffix: '%',  label: 'of all lifeguard rescues',        prefix: '' },
  { end: 60000,   suffix: '+',  label: 'people rescued per year',         prefix: '' },
  { end: 100,     suffix: '%',  label: 'preventable with knowledge',      prefix: '' },
]
