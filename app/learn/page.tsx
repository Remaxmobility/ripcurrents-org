...
const warningSigns = [
  { icon: '🌊', sign: 'Discoloured water', detail: 'A murky brown or greenish channel cutting through blue water — sediment pulled from the bottom.' },
  { icon: '🔇', sign: 'Absence of breaking waves', detail: 'A flat, calm-looking gap between two sections of breaking surf is the channel itself.' },
  { icon: '💨', sign: 'Choppy, disturbed surface', detail: 'Irregular surface chop in a narrow band where the current disrupts incoming swells.' },
  { icon: '🫧', sign: 'Foam or debris moving seaward', detail: 'Watch for floating foam, seaweed, or debris drifting steadily away from shore.' },
]

const survivalSteps = [
  { step: '1', title: 'Stay Calm', desc: "Panic wastes energy. A rip current won't pull you under — it will carry you away from shore." },
  { step: '2', title: "Don't Fight It", desc: 'Swimming directly against the current exhausts even strong swimmers. Work with the water, not against it.' },
  { step: '3', title: 'Swim Parallel', desc: 'Swim sideways — parallel to the shoreline — to escape the narrow channel. Most rip currents are less than 30 metres wide.' },
  { step: '4', title: 'Signal for Help', desc: 'If unable to escape, float and conserve energy. Wave and shout to attract a lifeguard or bystander.' },
]
      ...
      <main>
        ...
        <section className="relative pt-40 pb-24 bg-ocean-deep overflow-hidden">
          ...
          <div ref={hero.ref} className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              What rip currents are, how to spot them on Great Lakes beaches, and exactly what to do if you get caught in one.
            </p>
          </div>
        </section>
              ...
              <div>
                ...
                >
                  <p className="text-lg text-ocean-foam/80 font-body leading-relaxed">
                    A rip current is a <strong className="text-ocean-teal">powerful, concentrated channel of water</strong> that flows rapidly away from the shoreline and out into deeper water.
                  </p>
                  <p className="text-base text-ocean-foam/70 font-body leading-relaxed">
                    They form when water pushed toward shore by waves escapes through a gap in sandbars or along a pier, rushing outward in a narrow stream. At peak speed, a rip current moves faster than any Olympic swimmer — up to <strong className="text-white">2.5 metres per second</strong>.
                  </p>
                  <p className="text-base text-ocean-foam/70 font-body leading-relaxed">
                    Critically, rip currents are <strong className="text-danger-orange">not undertows</strong>. They flow along the surface, outward from shore. They will not pull you underwater — but they will exhaust you if you try to swim against them.
                  </p>
                </div>
              </div>
        ...
        <section className="py-24" style={{ background: 'linear-gradient(180deg, #010D1B 0%, #0A2540 100%)' }}>
          <div ref={lakes.ref} className="max-w-7xl mx-auto px-6">
            ...
            >
              {[
                {
                  title: 'Wind-Driven Formation',
                  desc: 'Unlike ocean rips that form from fixed underwater geography, Great Lakes rip currents are primarily driven by rapidly shifting winds and wave patterns — making them highly unpredictable.',
                },
                {
                  title: 'No Tidal Warning',
                  desc: "The Great Lakes have no tides to signal changing conditions. Rip currents can appear on seemingly calm days and shift location within minutes, with no advance warning system.",
                },
                {
                  title: 'Coldwater Factor',
                  desc: "Ontario's Great Lakes remain cold even in summer. Cold water causes involuntary gasping and rapid muscle fatigue — dramatically reducing a swimmer's ability to survive a rip current encounter.",
                },
              ].map((c) => (
                <div key={c.title} className="glass-card p-7">
                  <h3 className="font-display text-xl text-ocean-teal mb-4">{c.title.toUpperCase()}</h3>
                  <p className="text-ocean-foam/70 font-body leading-relaxed text-sm">{c.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-24 bg-ocean-deep">
          <div ref={signs.ref} className="max-w-7xl mx-auto px-6">
            <div className={`mb-14 transition-all duration-700 ${signs.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <p className="text-ocean-foam/60 font-body mt-4 max-w-xl">Always scan from an elevated position — a dune, lifeguard tower, or raised embankment — before entering the water.</p>
            </div>
          ...
          <div ref={survival.ref} className="max-w-7xl mx-auto px-6">
            ...
            >
              <div className="flex gap-4 items-start">
                ...
                <div>
                  <div className="font-semibold text-danger-orange font-body mb-1">NEVER swim directly toward shore against the current.</div>
                  <p className="text-sm text-ocean-foam/70 font-body leading-relaxed">
                    Fighting the current causes rapid exhaustion and drowning. Always swim parallel to shore first to escape the channel, then angle back to the beach.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 bg-ocean-deep">
          <div ref={stats.ref} className="max-w-4xl mx-auto px-6 text-center">
            <div
              className={`transition-all duration-700 ${stats.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              ...
              <p className="text-xl text-ocean-foam/80 font-body leading-relaxed mb-4">
                According to the Lifesaving Society, rip currents are responsible for the <strong className="text-white">majority of lifeguard rescues</strong> at Great Lakes beaches — and contribute to dozens of drowning deaths across Canada each year.
              </p>
              <p className="text-base text-ocean-foam/60 font-body leading-relaxed mb-12">
                Most victims were strong swimmers. Education is the only prevention.
              </p>
