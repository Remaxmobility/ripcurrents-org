...
const checklist = [
  'Check beach conditions and posted warning flags before you go.',
  'Choose beaches with lifeguards on duty whenever possible.',
  'Scan the water from an elevated position before anyone enters.',
  'Identify a rip current — a discoloured channel with no breaking waves.',
  'Stay within designated swimming areas and between the flags.',
  'Supervise children closely; stay within arm\'s reach of young swimmers.',
  'Know the survival rule: swim parallel to shore, not against the current.',
...
const talkingPoints = [
  {
    age: 'Ages 5–8',
    message: '"If the water ever pulls you away from shore, don\'t panic. Float on your back and call for help. Never try to swim back — swim sideways first."',
  },
  {
    age: 'Ages 9–13',
    message: '"A rip current is a river in the lake. It goes outward fast. The way out is sideways — swim parallel until you feel the pull stop, then angle back to shore."',
  },
  {
    age: 'Teens',
    message: '"Rip currents cause more Great Lakes drownings than any other hazard. Strong swimmers die in them because they fight back and exhaust themselves. The smart move is always sideways."',
  },
]
...
export default function FamiliesPage() {
  ...
  const checklist_ = useInView(0.15)
      ...
      <main>
        ...
        <section className="relative pt-40 pb-24 bg-ocean-deep overflow-hidden">
          ...
          <div ref={hero.ref} className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              Practical guidance for parents and caregivers visiting Great Lakes beaches in Ontario.
            </p>
          </div>
        </section>
              ...
              <div>
                ...
                >
                  <p className="text-lg text-ocean-foam/80 font-body leading-relaxed">
                    Rip currents are the <strong className="text-white">leading cause of drowning deaths</strong> at Great Lakes beaches — and they strike without warning. Most victims were good swimmers enjoying a normal day.
                  </p>
                  <p className="text-base text-ocean-foam/70 font-body leading-relaxed">
                    Young children and teenagers are especially vulnerable. Kids don&apos;t have the strength or experience to recognise the warning signs or respond correctly — and in cold Great Lakes water, the margin for error is slim.
                  </p>
                  <p className="text-base text-ocean-foam/70 font-body leading-relaxed">
                    The good news: a few minutes of preparation before every beach trip dramatically reduces the risk. Knowledge is the only prevention that works.
                  </p>
                </div>
              </div>
        ...
        <section className="py-24" style={{ background: 'linear-gradient(180deg, #010D1B 0%, #0A2540 100%)' }}>
          <div ref={checklist_.ref} className="max-w-7xl mx-auto px-6">
            <div className={`mb-14 transition-all duration-700 ${checklist_.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <p className="text-ocean-foam/60 font-body mt-4 max-w-xl">Print this out, save it to your phone, or just read it before every Great Lakes beach trip.</p>
            </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {checklist.map((item, i) => (
                <div
                  key={i}
                  className={`glass-card p-5 flex gap-4 items-start transition-all duration-700 ${checklist_.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
        ...
        <section className="py-24 bg-ocean-deep">
          <div ref={talk.ref} className="max-w-7xl mx-auto px-6">
            <div className={`mb-14 transition-all duration-700 ${talk.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <p className="text-ocean-foam/60 font-body mt-4 max-w-xl">Age-appropriate language to explain rip current danger before you reach the beach.</p>
            </div>
          ...
          <div ref={cta.ref} className="max-w-4xl mx-auto px-6 text-center">
            <div className={`transition-all duration-700 ${cta.visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              ...
              <p className="text-ocean-foam/70 font-body mb-10 max-w-xl mx-auto">
                Download our free beach safety materials, or bring a free rip current education presentation to your child&apos;s school this season.
              </p>
