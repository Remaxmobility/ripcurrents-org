...
const programFeatures = [
  {
    ...
    desc: 'All school presentations are provided at no cost to the school or board.',
  },
  {
    icon: '🎯',
    title: 'Age-Appropriate',
    desc: 'Tailored content for every grade level from Kindergarten through Grade 12.',
  },
  {
    icon: '📚',
    title: 'Curriculum-Aligned',
    desc: 'Mapped to Ontario Health and Physical Education and Science curriculum expectations.',
  },
  {
    icon: '🎬',
    title: 'Multimedia Delivery',
    desc: 'Engaging visuals, real-scenario footage, and interactive activities — not just a lecture.',
  },
]

const topics = [
  'What is a rip current and how does it form',
  'Why Great Lakes rip currents are uniquely dangerous',
  'How to recognise warning signs from shore',
  'The correct survival response: float, stay calm, swim parallel',
  'When and how to call for help',
  'Real incident case studies appropriate to grade level',
  'How to share safety knowledge with family and community',
]
      ...
      <main>
        ...
        <section className="relative pt-40 pb-24 bg-ocean-deep overflow-hidden">
          ...
          <div ref={hero.ref} className="max-w-4xl mx-auto px-6 text-center">
            ...
            >
              Free rip current safety presentations for Ontario schools — curriculum-aligned, engaging, and potentially life-saving.
            </p>
            <div
              ...
              <div>
                ...
                >
                  <p className="text-lg text-ocean-foam/80 font-body leading-relaxed">
                    Rip currents are the leading cause of water-related fatalities at Great Lakes beaches in Ontario. Children and teenagers are <strong className="text-white">among the highest-risk groups</strong> — yet rip current education is rarely part of school curriculum.
                  </p>
                  <p className="text-base text-ocean-foam/70 font-body leading-relaxed">
                    A single 45-minute presentation can permanently change how a student responds to a rip current emergency — for themselves, and for anyone around them. Students who learn this take that knowledge home to their families.
                  </p>
                  <p className="text-base text-ocean-foam/70 font-body leading-relaxed">
                    Our program is built specifically for Ontario classrooms, with age-appropriate content that connects directly to existing HPE and Science curriculum expectations.
                  </p>
                </div>
              </div>
          ...
          <div ref={curriculum.ref} className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                >
                  <div className="text-xs font-semibold tracking-[0.15em] uppercase text-ocean-teal font-body mb-1">{c.grades}</div>
                  <h3 className="font-display text-xl text-white mb-4">{c.subject.toUpperCase()}</h3>
          ...
          <div ref={booking.ref} className="max-w-3xl mx-auto px-6">
            ...
            >
              ...
              <p className="text-ocean-foam/70 font-body">
                Fill out our contact form and we&apos;ll schedule a presentation for your school at a time that works for you.
              </p>
            </div>
